...
import { Filter, Grid3X3, List, Plus, Search, Trello } from "lucide-react";
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-100 via-white to-purple-50">
            ...
            <main className="container mx-auto px-4 py-6 sm:py-8  ">
                ...
                {/* stats  */}
                <div className="grid grid-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
                    <Card>
                ...
                <div className="mb-6 sm:mb-8">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 sm:mb-6 space-y-4 sm:space-y-0 sm:space-x-4">
                        <div>
                            ...
                            {isFreeUser && (
                                <p>Free Plan: {boards.length}/1 boards used</p>
                            )} 
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6">
                            {boards.map((board, key) => (
                                <Link href={`/boards/${board.id}`} key={key}>
                                    <Card className="hover:shadow-lg transition-shadow cursor-pointer group">
                                        ...
                                        <CardContent className="p-4 sm:p-6">
                                            <CardTitle className="text-base sm:text-lg mb-2 group-hover:text-blue-600">{board.title}</CardTitle>
                            ...
                            <Card className="border-2 border-dashed border-gray-300 hover:border-blue-400 transition-colors cursor-pointer group" onClick={handleCreateBoard}>
                                <CardContent className="p-4 sm:p-6 flex flex-col items-center justify-center h-full min-h-[200px]">
                                    <Plus className="h-6 w-6 sm:h-8 sm:w-8 text-gray-400 group-hover:text-blue-600 sm-2 " />
