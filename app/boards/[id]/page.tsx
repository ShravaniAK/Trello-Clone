            ...
            <div className="bg-white rounded-lg shadow-sm border">
                ...
                <div className="p-3 sm:p-4 border-b ">
                    <div className="flex items-center justify-between">
                        ...
                        <Button variant='ghost' onClick={()=>onEditColumn(column)}>
                            <MoreHorizontalIcon />
                        </Button>
                    </div>
                </div>
            ...
            <Dialog open={isFilterOpen} onOpenChange={setIsFilterOpen}>
                <DialogContent className="w-[95vw] max-w-[425px] mx-auto ">
                    <DialogHeader>
                        ...
                        <p className="text-sm text-gray-600">Filter tasks by priority,assignee, or due data</p>
                    </DialogHeader>
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                type="date"
                         value={filters.dueDate || ""} onChange={(e)=>handleFilterChange("dueDate",e.target.value||null)}
                            />
                        </div>
            ...
            space-y-4 lg:space-y-0"
                >
                    ...
                    {filteredColumns.map((column, key) => (
                        <DroppableColumn key={key} column={column} onCreateTask={createTask} onEditColumn={handleEditColumn}>
                            <SortableContext items={column.tasks.map((task)=>(
                                task.id
                            ))} 
